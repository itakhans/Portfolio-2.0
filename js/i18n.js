...
const PROJECT_I18N = {
  "aperture-rebrand": {
    ...
    kk: {
      ...
      description:
        "Қазақстан Республикасы Президентінің Телерадио кешені әлеуметтік желілері мен онлайн іс-шараларына арналған күту экранының анимациясын әзірлеуге тапсырыс берді. Мен ұйымның үш медиаарнасының — PTRK, Kazinform және Jibek Joly — визуалдық стилін біріктіретін Рубик кубигі бейнеленген циклдік анимация жасадым. Кубик әртүрлі брендтер мен медиаформаттарды біртұтас визуалды композицияға біріктірудің метафорасы ретінде қолданылды.",
